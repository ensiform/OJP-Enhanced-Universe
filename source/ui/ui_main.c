...
uiRank_t uiRank[NUM_TOTAL_SKILLS] = 
{
	...
	{3,UI_FORCE_RANK_JETPACK,NUM_FORCE_POWERS+SK_JETPACK,0,qfalse,0},
	...
	{3,UI_FORCE_RANK_DETPACK,NUM_FORCE_POWERS+SK_DETPACK,0,qfalse,0},
	...
	{3,UI_FORCE_RANK_TRIPMINE,NUM_FORCE_POWERS + SK_TRIPMINE,0,qfalse,0},
	{3,UI_FORCE_RANK_DEMP2,NUM_FORCE_POWERS+SK_DEMP2,0,qfalse,0},
	...
	{3,UI_FORCE_RANK_REPAIR,NUM_FORCE_POWERS+SK_REPAIR,0,qfalse,0},
	{3,UI_FORCE_RANK_ELECTROSHOCKER,NUM_FORCE_POWERS+SK_ELECTROSHOCKER,0,qfalse,0},
	{3,UI_FORCE_RANK_SPHERESHIELD,NUM_FORCE_POWERS+SK_SPHERESHIELD,0,qfalse,0},			
	{3,UI_FORCE_RANK_OVERLOAD,NUM_FORCE_POWERS+SK_OVERLOAD,0,qfalse,0},		
	{3,UI_FORCE_RANK_SQUADTEAM,NUM_FORCE_POWERS+SK_SQUADTEAM,0,qfalse,0},	
	...
	{3,UI_FORCE_RANK_FIGHTERSHIPA,NUM_FORCE_POWERS+SK_FIGHTERSHIPA,0,qfalse,0},
	{3,UI_FORCE_RANK_BOMBERSHIPA,NUM_FORCE_POWERS+SK_BOMBERSHIPA,0,qfalse,0},
	{3,UI_FORCE_RANK_TRANSPORTSHIPA,NUM_FORCE_POWERS+SK_TRANSPORTSHIPA,0,qfalse,0},
	{3,UI_FORCE_RANK_LIGHTVEHICLEB,NUM_FORCE_POWERS+SK_LIGHTVEHICLEB,0,qfalse,0},
	{3,UI_FORCE_RANK_MEDIUMVEHICLEB,NUM_FORCE_POWERS+SK_MEDIUMVEHICLEB,0,qfalse,0},
	{3,UI_FORCE_RANK_HEAVYVEHICLEB,NUM_FORCE_POWERS+SK_HEAVYVEHICLEB,0,qfalse,0},
	{3,UI_FORCE_RANK_FIGHTERSHIPB,NUM_FORCE_POWERS+SK_FIGHTERSHIPB,0,qfalse,0},
	{3,UI_FORCE_RANK_BOMBERSHIPB,NUM_FORCE_POWERS+SK_BOMBERSHIPB,0,qfalse,0},
	{3,UI_FORCE_RANK_TRANSPORTSHIPB,NUM_FORCE_POWERS+SK_TRANSPORTSHIPB,0,qfalse,0},	
	{3,UI_FORCE_RANK_GRAPPLE,NUM_FORCE_POWERS+SK_GRAPPLE,0,qfalse,0},
	{3,UI_FORCE_RANK_AGILITY,NUM_FORCE_POWERS+SK_AGILITY,0,qfalse,0},
	{3,UI_FORCE_RANK_STRENGTH,NUM_FORCE_POWERS+SK_STRENGTH,0,qfalse,0},	
	{3,UI_FORCE_RANK_BACKPACKROCKET,NUM_FORCE_POWERS+SK_BACKPACKROCKET,0,qfalse,0},
	{3,UI_FORCE_RANK_BACKPACKROCKETA,NUM_FORCE_POWERS+SK_BACKPACKROCKETA,0,qfalse,0},
	{2,UI_FORCE_RANK_SPECIALCHARACTER,NUM_FORCE_POWERS+SK_SPECIALCHARACTER,0,qfalse,0},
	{3,UI_FORCE_RANK_JETPACKA,NUM_FORCE_POWERS+SK_JETPACKA,0,qfalse,0},
	{3,UI_FORCE_RANK_JETPACKB,NUM_FORCE_POWERS+SK_JETPACKB,0,qfalse,0},	
	{3,UI_FORCE_RANK_WRISTA,NUM_FORCE_POWERS+SK_WRISTA,0,qfalse,0},
	{1,UI_FORCE_RANK_WRISTB,NUM_FORCE_POWERS+SK_WRISTB,0,qfalse,0},
	{3,UI_FORCE_RANK_PISTOLA,NUM_FORCE_POWERS+SK_PISTOLA,0,qfalse,0},
	{1,UI_FORCE_RANK_PISTOLB,NUM_FORCE_POWERS+SK_PISTOLB,0,qfalse,0},
	{3,UI_FORCE_RANK_BLASTERA,NUM_FORCE_POWERS+SK_BLASTERA,0,qfalse,0},
	{1,UI_FORCE_RANK_BLASTERB,NUM_FORCE_POWERS+SK_BLASTERB,0,qfalse,0},
	{3,UI_FORCE_RANK_DISRUPTORA,NUM_FORCE_POWERS+SK_DISRUPTORA,0,qfalse,0},
	{1,UI_FORCE_RANK_DISRUPTORB,NUM_FORCE_POWERS+SK_DISRUPTORB,0,qfalse,0},
	{3,UI_FORCE_RANK_BOWCASTERA,NUM_FORCE_POWERS+SK_BOWCASTERA,0,qfalse,0},
	{1,UI_FORCE_RANK_BOWCASTERB,NUM_FORCE_POWERS+SK_BOWCASTERB,0,qfalse,0},
	{3,UI_FORCE_RANK_REPEATERA,NUM_FORCE_POWERS+SK_REPEATERA,0,qfalse,0},
	{1,UI_FORCE_RANK_REPEATERB,NUM_FORCE_POWERS+SK_REPEATERB,0,qfalse,0},
	{3,UI_FORCE_RANK_DEMP2A,NUM_FORCE_POWERS+SK_DEMP2A,0,qfalse,0},
	{1,UI_FORCE_RANK_DEMP2B,NUM_FORCE_POWERS+SK_DEMP2B,0,qfalse,0},
	{3,UI_FORCE_RANK_FLECHETTEA,NUM_FORCE_POWERS+SK_FLECHETTEA,0,qfalse,0},
	{1,UI_FORCE_RANK_FLECHETTEB,NUM_FORCE_POWERS+SK_FLECHETTEB,0,qfalse,0},
	{3,UI_FORCE_RANK_CONCUSSIONA,NUM_FORCE_POWERS+SK_CONCUSSIONA,0,qfalse,0},
	{1,UI_FORCE_RANK_CONCUSSIONB,NUM_FORCE_POWERS+SK_CONCUSSIONB,0,qfalse,0},
	{3,UI_FORCE_RANK_ROCKETSA,NUM_FORCE_POWERS+SK_ROCKETA,0,qfalse,0},
	{1,UI_FORCE_RANK_ROCKETSB,NUM_FORCE_POWERS+SK_ROCKETB,0,qfalse,0},
	{3,UI_FORCE_RANK_THERMALSA,NUM_FORCE_POWERS+SK_THERMALA,0,qfalse,0},
	{1,UI_FORCE_RANK_THERMALSB,NUM_FORCE_POWERS+SK_THERMALB,0,qfalse,0},	
	{3,UI_FORCE_RANK_TRIPMINEA,NUM_FORCE_POWERS+SK_TRIPMINEA,0,qfalse,0},
	{1,UI_FORCE_RANK_TRIPMINEB,NUM_FORCE_POWERS+SK_TRIPMINEB,0,qfalse,0},
	{3,UI_FORCE_RANK_DETPACKA,NUM_FORCE_POWERS+SK_DETPACKA,0,qfalse,0},
	{1,UI_FORCE_RANK_DETPACKB,NUM_FORCE_POWERS+SK_DETPACKB,0,qfalse,0},
	{3,UI_FORCE_RANK_OLDA,NUM_FORCE_POWERS+SK_OLDA,0,qfalse,0},
	{1,UI_FORCE_RANK_OLDB,NUM_FORCE_POWERS+SK_OLDB,0,qfalse,0},
	{3,UI_FORCE_RANK_FLAMETHROWERA,NUM_FORCE_POWERS+SK_FLAMETHROWERA,0,qfalse,0},
	{3,UI_FORCE_RANK_ELECTROSHOCKERA,NUM_FORCE_POWERS+SK_ELECTROSHOCKERA,0,qfalse,0},
	{2,UI_FORCE_RANK_LIGHTNINGA,NUM_FORCE_POWERS+SK_LIGHTNINGA,0,qfalse,0},
	{2,UI_FORCE_RANK_DRAINA,NUM_FORCE_POWERS+SK_DRAINA,0,qfalse,0},
	{2,UI_FORCE_RANK_GRIPA,NUM_FORCE_POWERS+SK_GRIPA,0,qfalse,0},
	{2,UI_FORCE_RANK_ABSORBA,NUM_FORCE_POWERS+SK_ABSORBA,0,qfalse,0},
	{2,UI_FORCE_RANK_PROTECTA,NUM_FORCE_POWERS+SK_PROTECTA,0,qfalse,0},
	{2,UI_FORCE_RANK_DESTRUCTIONA,NUM_FORCE_POWERS+SK_DESTRUCTIONA,0,qfalse,0},
	{2,UI_FORCE_RANK_HEALA,NUM_FORCE_POWERS+SK_HEALA,0,qfalse,0},
	{2,UI_FORCE_RANK_RAGEA,NUM_FORCE_POWERS+SK_RAGEA,0,qfalse,0},
	{2,UI_FORCE_RANK_TELEPATHYA,NUM_FORCE_POWERS+SK_TELEPATHYA,0,qfalse,0},
	{2,UI_FORCE_RANK_STASISA,NUM_FORCE_POWERS+SK_STASISA,0,qfalse,0},
	{2,UI_FORCE_RANK_PUSHA,NUM_FORCE_POWERS+SK_PUSHA,0,qfalse,0},
	{2,UI_FORCE_RANK_PULLA,NUM_FORCE_POWERS+SK_PULLA,0,qfalse,0},
	//Add new skills here
};
...
Q_EXPORT intptr_t vmMain( int command, int arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6, intptr_t arg7, intptr_t arg8, intptr_t arg9, intptr_t arg10, intptr_t arg11  ) {
...
static void UI_DrawForceSide(rectDef_t *rect, float scale, vec4_t color, int textStyle, int val, int min, int max, int iMenuFont)
{
	...
	if (val == FORCE_LIGHTSIDE)
	{
		...
		if ( menu2)
		{
			...
			Menu_ShowItemByName(menu2, "darkpowers_team", qfalse);

			Menu_ShowItemByName(menu2, "lightpowers_team", qtrue);//(ui_gameType.integer >= GT_TEAM));
		}
	}
	else
	{
		...
		if ( menu2 )
		{
			...
			Menu_ShowItemByName(menu2, "lightpowers_team", qfalse);
...
//				UI_LoadNonIngame();
	  ...
	  case UIMENU_PLAYERFORCE:
		 // trap_Cvar_Set( "cl_paused", "1" );
			...
			UI_BuildPlayerList();
			Menus_CloseAll();
			Menus_ActivateByName("ingame_playerforce1");
			UpdateForceUsed();
		  return;
	  case UIMENU_PLAYERFORCE2:
		 // trap_Cvar_Set( "cl_paused", "1" );
			trap_Key_SetCatcher( KEYCATCH_UI );
			UI_BuildPlayerList();
			Menus_CloseAll();
			Menus_ActivateByName("ingame_playerforce2");
			UpdateForceUsed();
		  return;
...
static cvarTable_t		cvarTable[] = {
	...
	//[TABBot]
	{ &ui_bottype, "ui_bottype", "0", CVAR_ARCHIVE|CVAR_INTERNAL },
	//[TABBot]
