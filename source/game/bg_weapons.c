...
{//	Fwd,	right,	up.
	{0,		0,		0	},	// WP_NONE,
	{12,	5,		-6	},	// WP_STUN_BATON,
	{0	,	8,		0	},	// WP_MELEE,
	{8	,	16,		0	},	// WP_SABER,				 
	{12,	5,		-6	},	// WP_BRYAR_PISTOL,
	{12,	6,		-6	},	// WP_BLASTER,
	{12,	6,		-6	},	// WP_DISRUPTOR,
	{12,	2,		-6	},	// WP_BOWCASTER,
...
//		"Bryar Pistol",			//	char	classname[32];		// Spawning name
		...
		//[WeaponSys]
		700,						//	int		fireTime;			// Amount of time between firings was 800
		...
		0,						//int		altChargeSub;		// above for secondary
		0,						//	int		maxCharge;			// stop subtracting once charged for this many ms
		700					//	int		altMaxCharge;		// above for secondary
	},
	{	// WP_BLASTER
//		"E11 Blaster Rifle",	//	char	classname[32];		// Spawning name
		...
		5,						//	int		ammoLow;			// Count when ammo is low
		//[WeaponSys]
		0,						//	int		energyPerShot;		// Amount of energy used per shot was 2
		450,					//	int		fireTime;			// Amount of time between firings was 350
		//2,					//	int		energyPerShot;		// Amount of energy used per shot
		//350,					//	int		fireTime;			// Amount of time between firings
		//[/WeaponSys]
		8192,					//	int		range;				// Range of weapon
		//[WeaponSys]
		0,						//	int		altEnergyPerShot;	// Amount of energy used for alt-fire was 3
...
//		"Tenloss Disruptor Rifle",//	char	classname[32];		// Spawning name
		...
		8192,					//	int		altRange;			// Range of alt-fire
		0,						//	int		chargeSubTime;		// ms interval for subtracting ammo during charge
		1500,					//	int		altChargeSubTime;	// above for secondary
		0,						//	int		chargeSub;			// amount to subtract during charge on each interval
		0,						//int		altChargeSub;		// above for secondary
		0,						//	int		maxCharge;			// stop subtracting once charged for this many ms
...
//		"Wookiee Bowcaster",	//	char	classname[32];		// Spawning name
		...
		5,						//	int		ammoLow;			// Count when ammo is low
		//[WeaponSys]
		0,						//	int		energyPerShot;		// Amount of energy used per shot was 5
		1200,					//	int		fireTime;			// Amount of time between firings was 1000
		//5,					//	int		energyPerShot;		// Amount of energy used per shot
		//1000,					//	int		fireTime;			// Amount of time between firings
		//[/WeaponSys]
		8192,					//	int		range;				// Range of weapon
		//[WeaponSys]
		0,						//	int		altEnergyPerShot;	// Amount of energy used for alt-fire was 5
		1200,					//	int		altFireTime;		// Amount of time between alt-firings was 750 -- was 350 [BowcasterChange]
		...
		0,						//	int		chargeSub;			// amount to subtract during charge on each interval
		0,						//int		altChargeSub;		// above for secondary
		1200,					//	int		maxCharge;			// stop subtracting once charged for this many ms
		0						//	int		altMaxCharge;		// above for secondary
	},
	{	// WP_REPEATER
//		"Imperial Heavy Repeater",//	char	classname[32];		// Spawning name
		...
		0,						//	int		energyPerShot;		// Amount of energy used per shot
		//[WeaponSys]
		100,						//	int		fireTime;			// Amount of time between firings was 100
...
//		"Bryar Pistol",			//	char	classname[32];		// Spawning name
		...
		0,						//	int		maxCharge;			// stop subtracting once charged for this many ms
		400//1500					//	int		altMaxCharge;		// above for secondary
...
//		"Emplaced Gun",			//	char	classname[32];		// Spawning name
		...
		120,					//	int		fireTime;			// Amount of time between firings
		8192,					//	int		range;				// Range of weapon
		/*3*/0,						//	int		altEnergyPerShot;	// Amount of energy used for alt-fire
		90,					//	int		altFireTime;		// Amount of time between alt-firings
		8192,					//	int		altRange;			// Range of alt-fire
		0,						//	int		chargeSubTime;		// ms interval for subtracting ammo during charge
		0,						//	int		altChargeSubTime;	// above for secondary
		0,						//	int		chargeSub;			// amount to subtract during charge on each interval
...
//		"",				//	char	icon[32];	// Name of ammo icon file
	...
	{	// AMMO_BLASTER
//		"",				//	char	icon[32];	// Name of ammo icon file
		500				//	int		max;		// Max amount player can hold of ammo
	},
	{	// AMMO_POWERCELL
//		"",				//	char	icon[32];	// Name of ammo icon file
		500				//	int		max;		// Max amount player can hold of ammo
...
//		"",				//	char	icon[32];	// Name of ammo icon file
		//[WeaponSys]
		500				//	int		max;		// Max amount player can hold of ammo; basejka: 300, was 1000
		//300				//	int		max;		// Max amount player can hold of ammo
		//[/WeaponSys]
	},
	{	// AMMO_ROCKETS
