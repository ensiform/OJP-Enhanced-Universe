...
#define MAX_CHAT_BUFFER_SIZE 16384
...
#define MAX_FORCE_INFO_SIZE 4096
...
#define MIN_BOTJETPACKFLIGHT_TIME	500 //5 SECOND
#define MAX_BOTJETPACKFLIGHT_TIME	1000 //10 SECONDS
...
#define BOT_SABER_THROW_RANGE		512
...
typedef struct bot_state_s
{
	...
	float				botItemWeights[HI_NUM_HOLDABLE];
	float				botForceTypeWeights[FT_NUM_TYPE];
	float				botWeaponTypeWeights[WT_NUM_TYPE];
	float				botItemTypeWeights[HT_NUM_TYPE];
	int					ctfState;
