...
#define FL_DISINTEGRATED		0x00200000  // marks that the corpse has already been disintegrated
...
struct gclient_s {
	...
	//[Dioxisthrower]
	int			dioxisTime;
	qboolean	dioxisdised;//When a jedi gets flamethrowed
	qboolean	dioxisThrowed;
	//[/Dioxisthrower]
	//[Icethrower]
	int			iceTime;
	qboolean	iced;//When a jedi gets flamethrowed
	qboolean	iceThrowed;
	//[/Icethrower]
	
	
	//[Electroshocker]
	int			electroshockerTime;
	qboolean	electroshockerhit;//When a jedi gets Electroshockerhit
	qboolean	electroshockerStroked;
	//[/Electroshocker]	 

	//[Lasersupport]
	int			lasersupportTime;
	qboolean	lasersupporthit;//When a jedi gets Electroshockerhit
	qboolean	lasersupportStroked;
	//[/Electroshocker]	 
	
	//[Orbitalstrike]
	int			orbitalstrikeTime;
	qboolean	orbitalstrikehit;//When a jedi gets Electroshockerhit
	qboolean	orbitalstrikeStroked;
	//[/Orbitalstrike]	 
	...
	int         blockTime;
	gentity_t *SquadTeam;
	gentity_t *SquadTeam2;
	gentity_t *SquadTeam3;
	gentity_t *SpecialCharacter;	
	gentity_t *VehicleMount;
...
extern  vmCvar_t	m_grapple_shoot_speed;
