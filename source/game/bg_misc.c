...
int forceMasteryPoints[NUM_FORCE_MASTERY_LEVELS] =
{
	...
	50,		// FORCE_MASTERY_INITIATE,
	100,		// FORCE_MASTERY_PADAWAN,
	200,		// FORCE_MASTERY_JEDI,
	300,		// FORCE_MASTERY_JEDI_GUARDIAN,
	500,		// FORCE_MASTERY_JEDI_ADEPT,
	600,		// FORCE_MASTERY_JEDI_KNIGHT,
	700		// FORCE_MASTERY_JEDI_MASTER,
};
...
//[/ExpSys]
{
	...
	{	0,	SABER_DEFENSE_L1,	8,	10	},	// Saber Defend	//FP_SABER_DEFENSE, -- lvl3 was 10
	{	0,	5,	8,	10	},	// Saber Throw	//FP_SABERTHROW,
	/* basejka values
	...
	{	0,	4,	6,	8	},	// Saber Defend	//FP_SABER_DEFENSE,
	...
	*/
	...
	{	0,	10,	0,	0	},	//SK_PURPLESTYLE,	//Purple lightsaber style
	{	0,	10,	0,	0	},	//SK_GREENSTYLE,	//Green lightsaber style
	...
	{	0,	1, 1,	 1	 },//SK_FIGHTERSHIPA,
	{	0,	1, 1,	 1	 },//SK_BOMBERSHIPA,
	{	0,	1, 1,	 1	 },//SK_TRANSPORTSHIPA,
	{	0,	1, 1,	 1	 },//SK_LIGHTVEHICLEB,
	{	0,	1, 1,	 1	 },//SK_MEDIUMVEHICLEB,
	{	0,	1, 1,	 1	 },//SK_HEAVYVEHICLEB,	
	...
	{	0,	1, 1,	 1	 },//SK_BLASTERA,
	{	0,	1, 0,	 0	 },//SK_BLASTERB,
	{	0,	1, 1,	 1	 },//SK_DISRUPTORA,
	{	0,	1, 0,	 0	 },//SK_DISRUPTORB,
	{	0,	1, 1,	 1	 },//SK_BOWCASTERA,
	{	0,	1, 0,	 0	 },//SK_BOWCASTERB,
	{	0,	1, 1,	 1	 },//SK_REPEATERA,
	{	0,	1, 0,	 0	 },//SK_REPEATERB,
	{	0,	1, 1,	 1	 },//SK_DEMP2A,
	{	0,	1, 0,	 0	 },//SK_DEMP2B,
	{	0,	1, 1,	 1	 },//SK_FLECHETTEA,
	{	0,	1, 0,	 0	 },//SK_FLECHETTEB,
	{	0,	1, 1,	 1	 },//SK_CONCUSSIONA,
	{	0,	1, 0,	 0	 },//SK_CONCUSSIONB,
	{	0,	1, 1,	 1	 },//SK_ROCKETA,
	{	0,	1, 0,	 0	 },//SK_ROCKETB,
	{	0,	1, 1,	 1	 },//SK_THERMALA,
	{	0,	1, 0,	 0	 },//SK_THERMALB,
	{	0,	1, 1,	 1	 },//SK_TRIPMINEA,
	{	0,	1, 0,	 0	 },//SK_TRIPMINEB,
	{	0,	1, 1,	 1	 },//SK_DETPACKA,
	{	0,	1, 0,	 0	 },//SK_DETPACKBB,
	{	0,	1, 1,	 1	 },//SK_OLDA,
	{	0,	1, 0,	 0	 },//SK_OLDB,
	{	0,	1, 1,	 1	 },//SK_FLAMETHROWERA,
	{	0,	1, 1,	 1	 },//SK_ELECTROSHOCKERA,
	{	0,	1, 1,	 0	 },//SK_LIGHTNINGA,
	{	0,	1, 1,	 0	 },//SK_DRAINA,
	{	0,	1, 1,	 0	 },//SK_GRIPA,
	{	0,	1, 1,	 0	 },//SK_ABSORBA,
	{	0,	1, 1,	 0	 },//SK_PROTECTA,
	{	0,	1, 1,	 0	 },//SK_DESTRUCTIONA,
	{	0,	1, 1,	 0	 },//SK_HEALA,
	{	0,	1, 1,	 0	 },//SK_RAGEA,
	{	0,	1, 1,	 0	 },//SK_TELEPATHYA,
	{	0,	1, 1,	 0	 },//SK_STASISA,
	{	0,	1, 1,	 0	 },//SK_PUSHA,
	{	0,	1, 1,	 0	 },//SK_PULLA,
};
...
int WeaponAttackAnim2[WP_NUM_WEAPONS] =
{
	...
	BOTH_FORCE_2HANDEDLIGHTNING_HOLD,//WP_STUN_BATON,
	FACE_TALK0,//WP_MELEE,
	BOTH_STAND2,//WP_SABER, //(has its own handling)
	...
	BOTH_ATTACK3,//BOTH_ATTACK12,//WP_DET_PACK,
	FACE_TALK0,//WP_CONCUSSION,
	BOTH_FORCE_2HANDEDLIGHTNING_HOLD,//WP_BRYAR_OLD,

	//NOT VALID (e.g. should never really be used):
	BOTH_STAND1,//WP_EMPLACED_GUN,
	BOTH_ATTACK1//WP_TURRET,
};
int WeaponReadyAnim3[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponReadyLegsAnim3[WP_NUM_WEAPONS] =
{
	BOTH_STAND1,//WP_NONE,
...
int WeaponAttackAnim3[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim4[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponAttackAnim4[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim5[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
	...
	TORSO_WEAPONREADY3,//TORSO_WEAPONREADY7,//WP_DEMP2,
	TORSO_WEAPONREADY3,//TORSO_WEAPONREADY8,//WP_FLECHETTE,
	BOTH_ATTACK4,//TORSO_WEAPONREADY9,//WP_ROCKET_LAUNCHER,
	TORSO_WEAPONREADY10,//WP_THERMAL,
	TORSO_WEAPONREADY10,//TORSO_WEAPONREADY11,//WP_TRIP_MINE,
	TORSO_WEAPONREADY10,//TORSO_WEAPONREADY12,//WP_DET_PACK,
	TORSO_WEAPONREADY3,//WP_CONCUSSION
...
int WeaponReadyLegsAnim5[WP_NUM_WEAPONS] =
{
	BOTH_STAND1,//WP_NONE,
...
int WeaponAttackAnim5[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim6[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponAttackAnim6[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim7[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponReadyLegsAnim7[WP_NUM_WEAPONS] =
{
	BOTH_STAND1,//WP_NONE,
...
int WeaponAttackAnim7[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim8[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponAttackAnim8[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
/*QUAKED item_shieldbooster (.3 .3 1) (-8 -8 -0) (8 8 16) suspended
Bacta canister pickup, heals 25 on use
*/
	{
		"item_shieldbooster",	//should be item_bacta
		"sound/weapons/w_pkup.wav",
		{ "models/map_objects/mp/bacta.md3", 
		0, 0, 0} ,
/* view */		NULL,			
/* icon */		"gfx/hud/i_icon_shieldbooster",
/* pickup *///	"Bacta Canister",
		25,
		IT_HOLDABLE,
		HI_SHIELDBOOSTER,
...
/*QUAKED item_squadteam (.3 .3 1) (-8 -8 -0) (8 8 16) suspended
Do not place. For siege classes ONLY.
*/
	{
		"item_squadteam", 
		"sound/weapons/w_pkup.wav",
		{ "models/items/psgun.glm", //replace me
		0, 0, 0} ,
/* view */		NULL,			
/* icon */		"gfx/hud/i_icon_squadteam",
/* pickup *///	"Sentry Gun",
		120,
		IT_HOLDABLE,
		HI_SQUADTEAM,
...
/*QUAKED item_vehiclemount (.3 .3 1) (-8 -8 -0) (8 8 16) suspended
Do not place. For siege classes ONLY.
*/
	{
		"item_vehiclemount", 
		...
		0, 0, 0} ,
/* view */		NULL,			
/* icon */		"gfx/hud/i_icon_vehiclemount",
/* pickup *///	"Sentry Gun",
		120,
		IT_HOLDABLE,
		HI_VEHICLEMOUNT,
...
/* sounds */ "",
			...
			//[Electroshocker]
	{
		...
		0, 0, 0} ,
/* view */		NULL,			
/* icon */		"gfx/hud/i_icon_electroshocker",
/* pickup *///	"Seeker Drone",
		120,
		IT_HOLDABLE,
		HI_ELECTROSHOCKER,
...
char *eventnames[] = {
	...
	"EV_USE_ITEM10",
	"EV_USE_ITEM11",
	"EV_USE_ITEM12",	//Electroshocker
	"EV_USE_ITEM13",	//sphereshield
	"EV_USE_ITEM14",	//overload
	"EV_USE_ITEM15",	
