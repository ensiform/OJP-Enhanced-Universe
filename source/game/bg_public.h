...
#define FATIGUELEVEL_HEAVY  5	//FP point level at which the player is completely exhausted
...
//[Flamethrower]
#define FLAMETHROWER_FUELCOST 1		//fuel cost of flamethrower per hit trace
//[/Flamethrower]
//[Electroshocker]
#define ELECTROSHOCKER_FUELCOST 1		//fuel cost of Electroshocker per hit trace
//[/Electroshocker]	
//[BUGFIX12]
...
#define EF_WP_OPTION_2			(1<<14)	// Additional Weapons Options..
#define	EF_WP_OPTION_3			(1<<15)		// Additional Weapons Options..
#define EF_WP_OPTION_4				(1<<16) // Additional Weapons Options..
#define EF_HI_OPTION_2			(1<<17) // Additional Items Options..
#define EF_HI_OPTION_3			(1<<18) // Additional Items Options..
//[CoOp]
...
//[/CoOp]
#define EF_ANIM_ALLFAST			(1<<19)		// automatically cycle through all frames at 10hz
//#define	EF_BODYPUSH				(1<<19)		//rww - claiming this for fullbody push effect
#define EF_FP_OPTION_2			(1<<20) // Additional Force Power Options..
...
#define	EF2_NOALTFIRE			(1<<8)		// no alternative fire
...
typedef enum {
	...
	EV_USE_ITEM9,
	EV_USE_ITEM10,
	EV_USE_ITEM11,	//use flamethrower
	EV_USE_ITEM12,	//use electroshocker
	EV_USE_ITEM13,	//use sphereshield
	EV_USE_ITEM14, //use overload
	EV_USE_ITEM15,
...
extern int WeaponReadyAnim3[WP_NUM_WEAPONS];
extern int WeaponAttackAnim3[WP_NUM_WEAPONS];
extern int WeaponReadyAnim5[WP_NUM_WEAPONS];
...
extern int WeaponReadyAnim4[WP_NUM_WEAPONS];
extern int WeaponAttackAnim4[WP_NUM_WEAPONS];
extern int WeaponReadyAnim6[WP_NUM_WEAPONS];
