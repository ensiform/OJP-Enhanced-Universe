...
char *HolocronIcons2[] = {
	...
	"gfx/mp/f_icon_lt_grip",		//FP_GRIP,
	"gfx/mp/f_icon_lt_l1",			//FP_LIGHTNING,
	"gfx/mp/f_icon_lt_rage",		//FP_RAGE,
	"gfx/mp/f_icon_dk_protect",		//FP_PROTECT,
	"gfx/mp/f_icon_dk_absorb",		//FP_ABSORB,
	"gfx/mp/f_icon_dk_healother",	//FP_TEAM_HEAL,
	"gfx/mp/f_icon_lt_forceother",	//FP_TEAM_FORCE,
	"gfx/mp/f_icon_lt_drain",		//FP_DRAIN,
	"gfx/mp/f_icon_sight",			//FP_SEE,
	"gfx/mp/f_icon_saber_attack",	//FP_SABER_OFFENSE,
	"gfx/mp/f_icon_saber_defend",	//FP_SABER_DEFENSE,
	"gfx/mp/f_icon_saber_throw"		//FP_SABERTHROW
