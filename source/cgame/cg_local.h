...
typedef struct {
	...
	qhandle_t	orangeFrontFlash;
	qhandle_t	redFrontFlash;	
	qhandle_t	blueFrontFlash;
	qhandle_t	yellowFrontFlash;	
...
//Chunks
	...
	qhandle_t	flameBodyShader;
	qhandle_t	flameBody2Shader;
	...
	sfxHandle_t incinerationSound;
	sfxHandle_t cryoSound;
	...
	*/
	...
	sfxHandle_t deploySquadTeam;
	sfxHandle_t deployVehicleMount;	
	...
	qhandle_t weaponIcons2[WP_NUM_WEAPONS];
	qhandle_t weaponIcons2_NA[WP_NUM_WEAPONS];
	qhandle_t weaponIcons3[WP_NUM_WEAPONS];
...
typedef struct
{
	...
	fxHandle_t	redShotEffect;
	fxHandle_t	blueShotEffect;
	fxHandle_t	whiteShotEffect;
	...
	fxHandle_t  emplacedWallImpactEffect;
	fxHandle_t  emplacedFleshImpactEffect;
	//FORCE
	
	fxHandle_t forceLightning;
	fxHandle_t forceLightningWide;
	fxHandle_t forceJudgement;
	fxHandle_t forceJudgementWide;
